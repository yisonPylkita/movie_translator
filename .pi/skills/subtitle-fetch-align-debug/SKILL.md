...
description: Debug fetched subtitle issues — wrong, rejected, or mis-timed subtitles. Covers provider fetching, validation scoring, ilass/xcorr alignment, and dialogue/non-dialogue classification in crates/mt-fetch.
---

# Subtitle Fetch & Align Debug

Specialist for the subtitle fetch + validation + alignment path. The
...
precede the first dialogue line** skew the timing-overlap score. Check
whether leading non-dialogue events are dragging the score down before
blaming the file.
